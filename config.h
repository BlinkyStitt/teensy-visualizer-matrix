...
// const float ms_per_frame = 11.5 + 14;  // 11.5 is as fast as the audio can go, but it takes 8ms to draw and we need multiple draws for dithering
...
uint8_t visualizer_color_value = 200;
uint8_t visualizer_white_value = 255;
